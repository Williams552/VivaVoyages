...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CouponCode).HasName("PK__Coupons__D34908015FF49E62");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__Customer__A4AE64B8F714914A");
        ...
        {
            entity.HasKey(e => e.DestinationId).HasName("PK__Destinat__DB5FE4AC2EE99B09");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Orders__C3905BAF7F9CE13C");
        ...
        {
            entity.HasKey(e => e.PassengerId).HasName("PK__Passenge__88915F9032492C96");
        ...
        {
            entity.HasKey(e => e.PlaceId).HasName("PK__Places__D5222B4EE8938D43");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__Staff__96D4AAF7659671C2");
        ...
        {
            entity.HasKey(e => e.TourId).HasName("PK__Tour__604CEA1052793AB3");
